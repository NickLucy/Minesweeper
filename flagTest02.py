...
def Order66():
    ...
    for i in range(10):
        for y in range(10):
            l2[i].append(sg.Button('?', size=(6, 3), pad = (1 , 1), key = (str(i) + str(y))))
